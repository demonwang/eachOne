...
public class Setting extends Activity implements OnClickListener{
	...
	private Handler hand = new Handler(){
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(Setting.this, "ÍøÂç´íÎó", Toast.LENGTH_SHORT).show();
				break;
			case 1:
				Toast.makeText(Setting.this, "µÇ³ö³É¹¦", Toast.LENGTH_SHORT).show();
				break;
			case 2:
				break;
			default:
				Toast.makeText(Setting.this, "µÇ³ö´íÎó", Toast.LENGTH_SHORT).show();
				break;
			}
		};
	};
